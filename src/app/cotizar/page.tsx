        ...
        >
          ...
          <div className="bg-white/[0.02] border border-white/10 rounded-3xl p-8 md:p-12 backdrop-blur-xl shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-10">
              ...
              <button 
                type="submit"
                className="group flex items-center justify-center gap-3 w-full bg-[#25D366] text-white rounded-xl py-5 font-semibold text-lg hover:bg-[#20bd5a] transition-colors shadow-[0_0_15px_rgba(37,211,102,0.3)] hover:shadow-[0_0_25px_rgba(37,211,102,0.5)]"
              >
